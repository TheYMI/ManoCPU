...
import Emulator.Components.DataRegister;
...
public class RegisterTest {
    ...
    @Before
    public void setUp() {
        tester = new DataRegister(0, "Tester");
    ...
    public void testSet_value() throws Exception {
        ...
        tester.update();
        assertEquals(5, tester.get_decimal());
        System.out.println("Value: " + value.toString() + " | Tester: " + tester.get_value().toString());

        tester.set_value(1, new Value(1, 1));
        tester.update();
        assertEquals(7, tester.get_decimal());
        System.out.println("Value: " + value.toString() + " | Tester: " + tester.get_value().toString());

        value.set_content(8);
        tester.set_value(1, 4, value);
        tester.update();
        assertEquals(17, tester.get_decimal());
        System.out.println("Value: " + value.toString() + " | Tester: " + tester.get_value().toString());
    ...
    public void testIncrement() throws Exception {
        ...
        tester.increment();
        tester.update();
        assertEquals(256, tester.get_decimal());
        System.out.println("Value: " + value.toString() + " | Tester: " + tester.get_value().toString());
